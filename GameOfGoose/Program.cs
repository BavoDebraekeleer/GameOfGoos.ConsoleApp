...
//IList<GameRule> rules = new List<GameRule>();
...
//    {
//        if (i == 50)
//            rules.Add(factory.Create(i, GameRuleType.Hangover));

//        rules.Add(factory.Create(i, GameRuleType.Default);
//    }
//}
